...
from .series_resolver import resolve_effective_student_series
...
async def build_assessment_policy_context(
    ...
    *,
    ...
    """Monta contexto com evidência de turma/matrícula sem escrever no banco."""
    ...
    return AssessmentPolicyContext(
        ...
        education_stage=(
            str(class_info.get("education_level") or class_info.get("nivel_ensino"))
            if (class_info.get("education_level") or class_info.get("nivel_ensino"))
            else None
        ),
        modality=(
            str(class_info.get("modality") or class_info.get("modalidade"))
            if (class_info.get("modality") or class_info.get("modalidade"))
            else None
        ),
    )
