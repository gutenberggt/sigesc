...
class UserUpdate(BaseModel):
    ...
    role: Optional[Literal['admin', 'admin_teste', 'ass_social', 'ass_social_2', 'agente_vacinas', 'secretario', 'diretor', 'coordenador', 'apoio_pedagogico', 'auxiliar_secretaria', 'professor', 'aluno', 'responsavel', 'semed', 'semed1', 'semed2', 'semed3']] = None
...
class StudentBase(BaseModel):
    ...
    legal_guardian_type: Optional[Literal['mother', 'father', 'both', 'self', 'other']] = None  # Mãe, Pai, Mãe e Pai, O(A) Aluno(a), Outro
...
class StudentUpdate(BaseModel):
    ...
    legal_guardian_type: Optional[Literal['mother', 'father', 'both', 'self', 'other']] = None
    guardian_name: Optional[str] = None
    guardian_cpf: Optional[str] = None
    guardian_rg: Optional[str] = None
    guardian_phone: Optional[str] = None
...
class StaffBase(BaseModel):
    ...
    cargo: Literal['apoio', 'apoio_pedagogico', 'auxiliar', 'auxiliar_secretaria', 'auxiliar_sala', 'auxiliar_servicos_gerais', 'coordenador', 'diretor', 'vice_diretor', 'mediador', 'merendeira', 'professor', 'secretario', 'vigia', 'zelador', 'outro']
...
class StaffUpdate(BaseModel):
    ...
    celular: Optional[str] = None
    email: Optional[str] = None
    cargo: Optional[Literal['apoio', 'apoio_pedagogico', 'auxiliar', 'auxiliar_secretaria', 'auxiliar_sala', 'auxiliar_servicos_gerais', 'coordenador', 'diretor', 'vice_diretor', 'mediador', 'merendeira', 'professor', 'secretario', 'vigia', 'zelador', 'outro']] = None
    cargo_especifico: Optional[str] = None
...
class SchoolAssignmentBase(BaseModel):
    ...
    # Função na escola
    funcao: Literal['apoio', 'apoio_pedagogico', 'professor', 'diretor', 'vice_diretor', 'coordenador', 'secretario', 'auxiliar_secretaria', 'auxiliar_sala', 'auxiliar', 'merendeira', 'zelador', 'vigia', 'mediador', 'outro'] = 'professor'
...
class SchoolAssignmentUpdate(BaseModel):
    funcao: Optional[Literal['apoio', 'apoio_pedagogico', 'professor', 'diretor', 'vice_diretor', 'coordenador', 'secretario', 'auxiliar_secretaria', 'auxiliar_sala', 'auxiliar', 'merendeira', 'zelador', 'vigia', 'mediador', 'outro']] = None
...
class PeriodoBimestral(BaseModel):
    ...
    dias_letivos: Optional[int] = None  # Quantidade de dias letivos do bimestre
...
class CalendarioLetivoUpdate(BaseModel):
    ...
    bimestre_1_inicio: Optional[str] = None
    bimestre_1_fim: Optional[str] = None
    bimestre_1_data_limite: Optional[str] = None
    bimestre_2_inicio: Optional[str] = None
    bimestre_2_fim: Optional[str] = None
    bimestre_2_data_limite: Optional[str] = None
    bimestre_3_inicio: Optional[str] = None
