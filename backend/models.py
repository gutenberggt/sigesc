...
class UserBase(BaseModel):
    full_name: str
    email: EmailStr
    role: Literal['admin', 'admin_teste', 'ass_social', 'agente_vacinas', 'secretario', 'diretor', 'coordenador', 'apoio_pedagogico', 'auxiliar_secretaria', 'professor', 'aluno', 'responsavel', 'semed', 'semed1', 'semed2', 'semed3']
...
class UserUpdate(BaseModel):
    ...
    role: Optional[Literal['admin', 'admin_teste', 'ass_social', 'agente_vacinas', 'secretario', 'diretor', 'coordenador', 'apoio_pedagogico', 'auxiliar_secretaria', 'professor', 'aluno', 'responsavel', 'semed', 'semed1', 'semed2', 'semed3']] = None
