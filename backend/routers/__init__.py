...
# Fase 6.5A observa o PDF individual depois da geração legado e registra apenas
# nomes de campos divergentes; o código 6.5B permanece preparado, mas DESARMADO
# no runtime até homologação explícita desta fase;
...
from aee_v2.plano_pdf_shadow import install_aee_v2_plano_pdf_shadow_setup
...
install_aee_v2_plano_pdf_shadow_setup(_aee_mod)
