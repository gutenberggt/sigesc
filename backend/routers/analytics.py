...
def setup_analytics_router(db, audit_service=None, sandbox_db=None):
    ...
    async def get_analytics_overview(
        ...
        # Conta alunos com status "active" na coleção students (mesma lógica da listagem de escolas)
        # Isso garante consistência entre a contagem na página de Escolas e no Dashboard
        
        student_filter = {"status": "active"}
        if school_id:
