"""Entrypoint de produção selado para a Segunda Onda DVD 2D-J.

Aceita somente modo e token de confirmação. Escopo, hashes, backup V2 e recibos
permanecem imutáveis no implementador. Dry-run é o comportamento padrão.
"""
...
from scripts import apply_dvd_second_wave_2d_j as implementation  # noqa: E402
