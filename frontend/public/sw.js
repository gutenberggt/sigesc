...
const CACHE_NAME = 'sigesc-cache-v18';
...
self.addEventListener('install', (event) => {
  console.log('[SW] Instalando Service Worker v2.12.4...');
...
console.log('[SW] Service Worker v2.12.4 carregado (login offline + cold-start robusto + pré-cache chunks + sessão à prova de revogação/reset + TTL 30d + diagnóstico visível)');
