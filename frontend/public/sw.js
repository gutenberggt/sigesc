...
const CACHE_NAME = 'sigesc-cache-v19';
...
self.addEventListener('install', (event) => {
  console.log('[SW] Instalando Service Worker v2.12.5...');
...
console.log('[SW] Service Worker v2.12.5 carregado (login offline + cold-start robusto + armazenamento persistente + pré-cache chunks + sessão à prova de revogação/reset + TTL 30d + diagnóstico visível)');
