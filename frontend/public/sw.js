...
const CACHE_NAME = 'sigesc-cache-v20';
...
self.addEventListener('install', (event) => {
  console.log('[SW] Instalando Service Worker v2.12.6...');
...
console.log('[SW] Service Worker v2.12.6 carregado (login offline + cold-start robusto + storage persistente + logout preserva sessão offline + pré-cache chunks + TTL 30d + diagnóstico visível)');
