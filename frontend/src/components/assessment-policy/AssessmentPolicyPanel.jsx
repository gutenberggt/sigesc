  ...
  const buildPolicy = useCallback(() => {
    ...
    const policy = {
      ...
      academic_outcome: {
        ...
        dependency: { enabled: false, outcomes: [] },
        council: {
          enabled: false,
      ...
      normative_sources: draft.normativeType.trim() && draft.normativeTitle.trim() ? [{
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          <div className="rounded-lg border bg-gray-50 p-3">
            ...
            <Button
              ...
              disabled={legacy.media_aprovacao == null}
            >
          ...
          <div className="rounded-lg border bg-gray-50 p-3">
            ...
            <Button
              ...
              disabled={legacy.frequencia_minima == null}
            >
              Usar explicitamente no rascunho
            </Button>
          </div>
              ...
              <div key={policy.id} className="flex flex-col gap-2 rounded-lg border p-3 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    {policy.policy_key} · v{policy.version} · {policy.academic_year} · {statusLabel[policy.status] || policy.status}
                  </p>
                </div>
        ...
        {editorOpen && (
          <div className="space-y-6 rounded-xl border border-blue-200 bg-blue-50/30 p-4" data-testid="assessment-policy-editor">
            <div>
              <h3 className="font-semibold text-gray-900">Assistente de configuração — novo rascunho</h3>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div>
                ...
                <Input value={draft.policyKey} onChange={(event) => setField('policyKey', event.target.value)} placeholder="Ex: EF_1_2_CONCEITUAL_2026" />
              </div>
              ...
              <div>
                <Label>Versão</Label>
                <Input type="number" min="1" value={draft.version} onChange={(event) => setField('version', event.target.value)} />
              </div>
              <div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <TechnicalTextarea
                ...
                help="Necessário para o dry-run. Não integra a norma; documenta como os campos atuais alimentam a policy."
