...
const DOCUMENT_CATALOG = [
  ...
  },
  {
    ...
    summary: 'Comprova que o estudante está matriculado em determinada escola/turma/série em um ano letivo.',
    issuedFrom: 'Declarações Escolares',
    issuedRoute: '/admin/declaracoes',
    howTo: 'Vá em Declarações Escolares → escolha o estudante → tipo "Matrícula" → indique a finalidade → "Emitir e baixar PDF".',
    color: 'emerald',
  },
  {
    type: 'frequencia',
    ...
    summary: 'Comprova o percentual de frequência do estudante em um período (bimestre, ano letivo).',
    issuedFrom: 'Declarações Escolares',
    issuedRoute: '/admin/declaracoes',
    howTo: 'Vá em Declarações Escolares → escolha o estudante → tipo "Frequência" → indique o período → "Emitir e baixar PDF".',
    color: 'cyan',
  },
  {
    type: 'escolaridade',
    ...
    issuedFrom: 'Declarações Escolares',
    issuedRoute: '/admin/declaracoes',
    howTo: 'Vá em Declarações Escolares → escolha o estudante → tipo "Escolaridade" → indique a finalidade → "Emitir e baixar PDF".',
    color: 'teal',
  },
  {
    type: 'historico',
    ...
    issuedFrom: 'Ficha do Estudante · Botão "Histórico"',
    issuedRoute: '/admin/students',
    howTo: 'Vá em Estudantes → clique no estudante → aba "Histórico" → botão "Imprimir/Baixar Histórico". O PDF traz código + QR.',
    color: 'indigo',
  },
  {
    type: 'certificado',
    ...
    issuedFrom: 'Ficha do Estudante · Botão "Certificado"',
    issuedRoute: '/admin/students',
    howTo: 'Disponível APENAS para estudantes do 9º Ano EF e EJA 4ª Etapa. Vá em Estudantes → ficha → botão "Certificado" no canto superior direito.',
    color: 'amber',
  },
  {
    type: 'ata',
