...
17. **Layout Certidao Civil (P0 RESOLVIDO):** Campo Numero/Matricula aumentado (3 colunas), Livro e Folha reduzidos (1 coluna cada). Grid alterado de 4 para 6 colunas. Cartorio expandido para 3 colunas, Cidade para 2 colunas.
18. **Lista de Turmas nao atualizava (P1 RESOLVIDO):** Adicionado cache busting (_t timestamp) nas requisicoes GET de turmas. Implementada atualizacao otimista no frontend apos criar/editar turma.
