  ...
  return (
    <div className="flex-grow p-6 bg-gray-100">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">Meu Perfil SIGESC</h2>
        ...
        <div className="flex flex-col items-center text-center mb-10">
          <div className="relative w-32 h-32 rounded-full bg-gray-200 overflow-hidden shadow">
            {userData.photoURL ? (
              ...
              <div className="w-full h-full flex items-center justify-center text-gray-500">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  strokeWidth={1.5} stroke="currentColor" fill="none" className="w-16 h-16">
            ...
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                strokeWidth={2} stroke="currentColor" fill="none" className="w-4 h-4">
                <path strokeLinecap="round" strokeLinejoin="round"
          ...
          <div className="mt-4">
            <p className="text-2xl font-semibold text-gray-900">{userData.nome}</p>
            <p className="text-sm text-blue-700">
              {userData.funcao ? userData.funcao.charAt(0).toUpperCase() + userData.funcao.slice(1) : 'Função Não Definida'}
            </p>
            <p className="text-sm text-gray-600">{userData.email}</p>
            <p className="text-sm text-gray-600">{formatTelefone(userData.telefone || '')}</p>
            <p className="text-gray-800 mt-3">{userData.biografia || 'Adicione uma biografia ao seu perfil.'}</p>
          </div>
        </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            {!isEditing ? (
              ...
              <form onSubmit={handleUpdateProfile} className="space-y-4">
                ...
                <div>
                  <label htmlFor="editBio" className="block text-sm font-medium text-gray-700">Biografia</label>
                  <textarea
                    id="editBio"
                    className="mt-1 block w-full p-2 border border-gray-300 rounded-md"
                    rows={3}
