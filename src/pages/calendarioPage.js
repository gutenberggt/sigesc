...
const ColoredDateCellWrapper = ({ children, value, events }) => {
  const event = events.find((e) => moment(e.start).isSame(value, "day"));
  ...
  return (
    <div className="p-6">
      <div className="bg-white p-8 rounded-lg shadow-md max-w-7xl mx-auto flex flex-col min-h-[85vh]">
        ...
        <div className="flex flex-wrap justify-between items-center mb-4 flex-shrink-0">
          ...
          <div className="flex space-x-1 border p-1 rounded-md bg-gray-100">
            <button
              ...
              className={`px-3 py-1 text-sm rounded ${view === "year" ? "bg-blue-600 text-white" : "bg-transparent"}`}
            >
              Ano
            </button>
            <button
              onClick={() => setView("month")}
              className={`px-3 py-1 text-sm rounded ${view === "month" ? "bg-blue-600 text-white" : "bg-transparent"}`}
            >
              Mês
            </button>
            <button
              onClick={() => setView("week")}
              className={`px-3 py-1 text-sm rounded ${view === "week" ? "bg-blue-600 text-white" : "bg-transparent"}`}
            >
              Semana
            </button>
            <button
              onClick={() => setView("day")}
              className={`px-3 py-1 text-sm rounded ${view === "day" ? "bg-blue-600 text-white" : "bg-transparent"}`}
            >
              Dia
            </button>
            <button
              onClick={() => setView("agenda")}
              className={`px-3 py-1 text-sm rounded ${view === "agenda" ? "bg-blue-600 text-white" : "bg-transparent"}`}
            >
              Agenda
            </button>
          </div>
        ...
        {error && (
          <p className="text-red-500 text-center mb-4 flex-shrink-0">{error}</p>
        )}
